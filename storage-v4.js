...
function classroomMeaningfulData(payload = classroomDataPayload()) {
  return ["lessons", "materials", "calendarEvents", "students", "learners", "smallGroups", "learnerPlans", "teachingMemory", "templates", "imports", "libraryCollections", "automationRules", "automationRuns"].some(k => Array.isArray(payload[k]) && payload[k].length);
}
