...
function issueIconV4(kind){return kind==="closure"?"!":kind==="overdue"?"↪":kind==="plan"?"＋":"○"}
...
$("#automationIssueList").addEventListener("click",e=>{const b=e.target.closest('[data-open-issue-lesson]');if(b)openLessonDialog(b.dataset.openIssueLesson)});
